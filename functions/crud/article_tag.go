...
func CreateArticleTag(c echo.Context) error {
	...
	return common.HandleSuccess(c, "Article tag created successfully", articleTag, http.StatusCreated)
}
...
func GetAllArticleTags(c echo.Context) error {
	...
	return common.HandleSuccess(c, "Successfully retrieved article tags", articleTags, http.StatusOK)
}
...
func GetArticleTag(c echo.Context) error {
	...
	return common.HandleSuccess(c, "Successfully retrieved article tag", articleTag, http.StatusOK)
}
...
func UpdateArticleTag(c echo.Context) error {
	...
	return common.HandleSuccess(c, "Article tag updated successfully", articleTag, http.StatusAccepted)
}
...
func DeleteArticleTag(c echo.Context) error {
	...
	return common.HandleSuccess(c, "Article tag deleted successfully", articleTag, http.StatusAccepted)
}
